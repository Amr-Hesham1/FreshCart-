...
import login from '../../assets/Computer login-amico.png'
    ...
    return (
        <>
            <div className='my-10 m-auto lg:gap-10 grid md:grid-cols-5'>
                ...
                <img src={login} className='md:col-span-2 w-full' alt="Login" />
                <form onSubmit={Formik.handleSubmit} className=" w-4/5 m-auto md:col-span-3">
                    <h1 className='text-center font-extrabold text-5xl text-sky-700 italic font-serif py-9 lg:py-16'>LogIn   <i className="fa-solid fa-right-to-bracket" /></h1>
                    ...
                    <Input value={Formik.values.password} onChange={Formik.handleChange} onBlur={Formik.handleBlur} className='col-span-2 md:mx-6 my-8  ' name='password' label="Password" type="password" endContent={<LockIcon className="text-2xl text-default-400 pointer-events-none flex-shrink-0" />} />
                    <Link to={'/forgetPassword'} className=' block text-right text-sky-700 hover:text-sky-600 transition-all  duration-75 font-medium text-sm ' >Forgot password ?</Link>
